...
class unet_3enco_concat_dropout(nn.Module):
    def __init__(self, num_classes, input_channels, input_channels_lidar, input_channels_radar, features_start=64, bilinear=True, dropout_rate = 0.5):
        super(unet_3enco_concat_dropout, self).__init__()

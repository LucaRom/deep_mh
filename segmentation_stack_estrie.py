...
from unet_stack import unet_stack
from pytorch_lightning.callbacks import Callback, ModelCheckpoint

# Custom LR
from utils import get_loaders, get_loaders_estrie, get_loaders_estrie_split
...
class SemSegment(LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        #val_loss = torch.nn.CrossEntropyLoss()(preds, mask_loss)
    ...
    def test_step(self, batch, batch_idx):
        ...
        return {'conf matrice': conf_print, 'preds' : preds, 'x' : x, 'y' : y, 'img_path' : img_path}
...
if __name__ == "__main__":
    ...
    # Paths estrie
    # e_img_dir = "D:/00_Donnees/01_trainings/02_mh_double_stack/estrie/sen2_very_smoll"
    ...
    # Paths estrie2
    e_img_dir = "D:/00_Donnees/01_trainings/02_mh_double_stack/estrie2/sen2"
    e_mask_dir = "D:/00_Donnees/01_trainings/02_mh_double_stack/estrie2/mask_bin"
    # #e_mask_dir = "D:/00_Donnees/01_trainings/02_mh_double_stack/estrie/mask_multi" # Multiclass # TODO CHANGE DATASET TO CHANGE NAMES :\
    e_lidar_dir = "D:/00_Donnees/01_trainings/02_mh_double_stack/estrie2/lidar_mnt"

    # path kenauk
    # e_img_dir= "D:/00_Donnees/01_trainings/mh_sentinel_2/sen2_print/train"
    # e_mask_dir = "D:/00_Donnees/01_trainings/mh_sentinel_2/mask_bin/train"
    # e_lidar_dir = "D:/00_Donnees/01_trainings/mh_sentinel_2/lidar_mnt/train"
    ...
    test_region = 'split' # split ou kenauk

    train_loader, val_loader, test_loader = get_loaders_estrie_split(
    test_region,
    e_img_dir,
    e_mask_dir,
    e_lidar_dir,
